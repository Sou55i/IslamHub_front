...
import { useDouaas } from '../context/DouaaProvider';

export const Douaas: React.FC = () => {
  const { douaas, isLoading, error} = useDouaas();

  if (isLoading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <p className="text-emerald-600 font-amiri">Loading douaas...</p>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="relative text-center px-4">
          <h1 className="text-4xl font-bold text-white mb-4 font-amiri">Daily Douaas</h1>
