    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-emerald-50 dark:from-gray-900 dark:to-emerald-950">
      ...
      >
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-emerald-200 max-w-3xl mx-auto mb-6">
      ...
      <main className="container mx-auto px-4 py-12 -mt-8 relative z-10">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-emerald-600 to-amber-600 rounded-2xl p-8 text-white shadow-xl mb-8"
        >
        ...
        <div className="space-y-6">
          {/* Les wahhabites contredisent l'imam Ahmad */}
          <CollapsibleSection
            title="Les wahhabites contredisent l'imam Ahmad"
            icon={<Shield className="w-5 h-5" />}
            defaultOpen={true}
          >
            <p>
              (Cette section met en évidence les différences entre la croyance authentique de l'Imam Ahmad et ceux qui prétendent le suivre de nos jours.)
            </p>
          </CollapsibleSection>
        ...
        >
          <div className="bg-gradient-to-r from-emerald-600 to-amber-600 rounded-2xl p-8 text-white shadow-xl">
            ...
            <p className="text-emerald-100">— L'Imam Ahmad Ibnou Hanbal</p>
          </div>
        </motion.div>
      </main>
