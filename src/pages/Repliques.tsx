        ...
        <div className="space-y-8">
            ...
            >
                ...
                <div className="relative text-center px-4">
                    <h1 className="text-4xl font-bold text-white mb-4 font-amiri">بِسم الله الرّحمـٰن الرّحيم
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {['Réplique à ceux qui ne croient pas en l\'existence de Dieu', 'Réplique aux égarés qui attribuent à Dieu le corps et l\'endroit', 'Réplique à ceux qui croient que Dieu serait localisé\n' +
                    '\n' +
                    'dans le ciel ou sur un trône', 'Réplique à ceux qui interdisent la récitation du Qour\'an pour les morts musulmans', 'Réplique à ceux qui interdisent le tawassoul', 'L\'innovation (al-bid^ah)', 'Réplique à ceux qui interdisent le tabarrouk', 'Réplique à ceux qui soutiennent la théorie de Darwin\n' +
                    '\n' +
                    '[théorie de l\'évolution des espèces]', 'Extraits de livres de savants'].map((topic, index) => (
                        <motion.div
                            key={topic}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
