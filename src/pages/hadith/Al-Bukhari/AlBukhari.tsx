...
const AlBukhari: React.FC = () => {
  return (
    <div className="space-y-8">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <ul className="space-y-2 text-right">
            <li>
              <a href="#part1" className="text-emerald-600 dark:text-emerald-400 hover:underline">
                الجزء الأول
              </a>
            </li>
            <li>
              <a href="#part2" className="text-emerald-600 dark:text-emerald-400 hover:underline">
      ...
      {/* Section 1 : الجزء الأول */}
      <div id="part1" className="max-w-7xl mx-auto px-4 space-y-8 pt-16 -mt-16">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          {/* Ajoutez les autres hadiths ici */}
        </motion.div>
      </div>

      {/* Section 2 : القسم الثاني من الكتاب */}
      <div id="part2" className="max-w-7xl mx-auto px-4 space-y-8 pt-16 -mt-16">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-2xl font-bold text-emerald-900 dark:text-emerald-300 text-right font-amiri">
            القسم الثاني من الكتاب
          </h2>
          <p className="text-gray-600 dark:text-gray-300 text-right">
            محتوى القسم الثاني من صحيح البخاري.
          </p>
        </motion.div>
      </div>
