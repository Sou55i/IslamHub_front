        ...
        <div className="space-y-8">
            ...
            >
                ...
                <div className="relative text-center px-4">
                    <h1 className="text-4xl font-bold text-white mb-4 font-amiri">Les sectes</h1>
                    <p className="text-lg text-emerald-50 max-w-2xl mx-auto">
                        Certes cette communauté se séparera en soixante-treize groupes, soixante-douze sont en enfer et un seul est au paradis. C’est la majorité
                    </p>
                    <p className="text-lg text-emerald-50 max-w-2xl mx-auto">
